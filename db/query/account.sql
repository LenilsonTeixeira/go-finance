...
SELECT a.id, a.user_id, a.title, a.type, a.description, a.value, a.created_at, c.title as category_title FROM accounts a 
...
UPDATE accounts SET title = $2, description = $3, value = $4, date = $5 WHERE id = $1 RETURNING *;
